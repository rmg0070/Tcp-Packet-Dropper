...
//     // Extract the protocol field (byte offset 9 in the IPv4 header)
//     let protocol: u8 = unsafe { *((ipv4hdr as *const u8).add(9)) };

//     let action = if block_ip(source) {
//         xdp_action::XDP_DROP
//     } else {
//         // Check if it's TCP (protocol 6) or UDP (protocol 17)
//         match protocol {
...
//                 }
//             },
//             _ => xdp_action::XDP_PASS,  // Other protocols, allow by default
//         }
//     };

//     info!(&ctx, "SRC: {:i}, PROTO: {}, ACTION: {}", source, protocol, action);
